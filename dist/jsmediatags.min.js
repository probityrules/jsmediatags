...
function(b,d,a,e,m){e=b;m=v(a.getByteAt(b));b+=1;var g=a.getStringAt(b,3);b+=3;var f=["unset","frames","milliseconds"][a.getByteAt(b)];b+=1;var h="other lyrics transcription movement events chord trivia".split(" ")[a.getByteAt(b)];b+=1;var c=a.getStringWithCharsetAt(b,d+e-b,m);b+=c.bytesReadCount;for(var k=[],l;b<d+e;)l=a.getStringWithCharsetAt(b,d+e-b,m),b+=l.bytesReadCount,k.push({text:l.toString(),timeStamp:a.getLongAt(b,!0)}),b+=4;return{language:g,timeStampFormat:f,contentType:h,descriptor:c.toString(),
